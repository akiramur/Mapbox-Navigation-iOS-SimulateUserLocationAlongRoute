//
//  SimulatedRouteLocationManager.swift
//  SimpleNavigationView
//
//  Created by Akira Murao on 2022/06/06.
//
...
/**
 The `SimulatedRouteLocationManager` class simulates location updates along a given route.
 ...
 */
open class SimulatedRouteLocationManager: NavigationLocationManager {
    
    /**
     Initalizes a new `SimulatedRouteLocationManager` with the given route.
     
     - parameter route: The initial route.
     - returns: A `SimulatedRouteLocationManager`
     */
    ...
    /**
     Initalizes a new `SimulatedRouteLocationManager` with the given routeProgress.
    ...
    */
    ...
    private let queue = DispatchQueue(label: "com.mapbox.SimulatedRouteLocationManager")
    ...
    internal func tick() {
        ...
        //print("CLLocationCoordinate2D(latitude: \(newCoordinate.latitude), longitude: \(newCoordinate.longitude)),")
    ...
    open override func copy() -> Any {
        let copy = SimulatedRouteLocationManager(route: route!)
